...
//Attaches a mousemove event handler on the canvas.
...
(function drawScreen() {
    ...
    drawCircle(x, y, circleRadius, randomColor); //Draws the user circle.
...
function calculatePosition() {
    if (mouseX > x || touchX > x) { //if (mouseX > x) - The code in the if statement will run if the x value of the mouse (mouseX) is greater than (>) the x value of the circle (x). 
        x += velocity;
    } else if (mouseX < x || touchX < x) { //In this case the condition is false if mouseX is less than (<) x. When mouseX is less than x we must reduce x to get the circle closer to mouseX.
        x -= velocity;
    }
    if (mouseY > y || touchY > y) { //if (mouseY > Y) - The code in the if statement will run if the y value of the mouse (mouseY) is greater than (>) the y value of the circle (y). 
        y += velocity;
    } else if (mouseY < y || touchY < y) { //In this case the condition is false if mouseY is less than (<) y. When mouseY is less than y we must reduce y to get the circle closer to mouseY.
        y -= velocity;
    }
}
